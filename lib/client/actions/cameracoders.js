...
export function loadCameraCoders (callback) {
  return dispatch => {
    ...
    superagent.get('http://localhost:4000/api/cameracoders')
...
export function startCameraCoder (cameraId) {
  return dispatch => {
    ...
    superagent.post('http://localhost:4000/api/cameracoders/' + cameraId + '/start')
      .accept('application/json')
      .end((err, res) => {
        if (err) {
...
export function stopCameraCoder (cameraId) {
  return dispatch => {
    ...
    superagent.post('http://localhost:4000/api/cameracoders/' + cameraId + '/stop')
      .accept('application/json')
      .end((err, res) => {
        if (err) {
