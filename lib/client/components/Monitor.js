...
class Home extends Component {
  ...
  handleChangeCamera (cameraId) {
    this.setState({
      ...
      mpdUrl: 'http://localhost:8888/api/mpds/' + cameraId + '/mpd'
    });
  }
          ...
          <Paper>
            ...
            <FlatButton
              ...
              onClick={(e) => {
                ...
                this.setState({
                  mpdUrl: 'http://localhost:8888/api/mpds/' + this.state.selectedCameraId + '/mpd?startTime=' + startTime + '&endTime=' + endTime
                });
              }}
            />
          </Paper>
